...
create_vms(){
    ...
    for project_id in $projects; do
        ...
        for zone in "${zones[@]}"; do
            ...
            --create-disk=auto-delete=yes,boot=yes,device-name="$instance_name",image=projects/ubuntu-os-cloud/global/images/ubuntu-2204-jammy-v20240607,mode=rw,size=140,type=projects/"$project_id"/zones/"$zone"/diskTypes/pd-balanced \
